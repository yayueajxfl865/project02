...
<body>
	<div class="place">
		<span>位置：</span>
		<ul class="placeul">
			<li><a href="<%=path %>/GoodsServlet?method=goodsList&kind=y">首页</a></li>
			<li><a href="#">查看用户</a></li>
		</ul>
	</div>
	<form method="post">
...
<ul class="forminfo">
	...
	<li><label>拾到地点</label> <input name="pname" type="text" 
		value="${goodsByid.place } " class="dfinput" /><i></i></li>
		
	<li><label>拾到时间</label> <input name="pname" type="text" 
	...
	<li><a href="GoodsServlet?method=goodsList&kind=y" target="rightFrame">返回首页</a></li>
	</div>
</ul>
		</div>
	</form>
