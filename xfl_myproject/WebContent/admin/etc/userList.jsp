...
<c:forEach items="${List_user }" var="user" varStatus="status">
	<tr>
		...
		<td><a href="<%=path%>/UserServlet?method=queryById&otId=${user.getId() } " class="tablelink">查看</a>
		 	<a href="<%=path%>/UserServlet?method=delete&otId=${user.getId() } " class="tablelink"> 删除</a>
		 </td>
	</tr>
</c:forEach>		
			</tbody>
