...
<tr>
	...
	<td>
	<a href="<%=path%>/ShangPinServlet?method=queryById_pass&pdId=${shangpin.getId() }" class="tablelink">查看</a>		
	<a href="<%=path%>/ShangPinServlet?method=delete_pass&pdId=${shangpin.getId() }" class="tablelink"> 删除</a>
