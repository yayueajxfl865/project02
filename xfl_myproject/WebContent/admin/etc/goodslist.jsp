...
<c:forEach items="${gsList }" var="user" varStatus="status">
	<tr>
		...
		<td><a href="<%=path%>/GoodsServlet?method=queryById&otId=${user.getId() } " class="tablelink">查看</a>
		 	<a href="<%=path%>/GoodsServlet?method=delete&otId=${user.getId() } " class="tablelink"> 删除</a>
		 </td>
	</tr>
</c:forEach>		
			</tbody>
