<%@page import="com.myproject.domethod.Region"%>
...
<head>
<title>聊天室</title>
<link href="css/styleforchat.css" rel="stylesheet">
...
var sysBBS = "<span style='font-size:14px; line-height:30px;'>欢迎光临心之语聊天室，请遵守聊天室规则，不要使用不文明用语。</span><br><span style='line-height:22px;'>";var sysBBS = "<span style='font-size:14px; line-height:30px;'>欢迎光临心之语聊天室，请遵守聊天室规则，不要使用不文明用语。</span><br><span style='line-height:22px;'>";
	...
	function set(selectPerson){	//自动添加聊天对象
		if(selectPerson != "${existUser.yb_username}"){
...
<body>
	...
	<table width="778" height="129" border="0" align="center"
		cellpadding="0" cellspacing="0" background="image/top.jpg">
		<tr>
			<td>&nbsp;</td>
		</tr>
	</table>
	<table width="778" height="276" border="0" align="center"
		...
		<tr>
			...
			<td width="613" height="200px" valign="top"
				background="image/main_bj.jpg" bgcolor="#FFFFFF"
				style="padding:5px; ">
	...
	<table width="778" height="95" border="0" align="center"
		...
		<form action="" id="form1" name="form1" method="post">
			...
			<input type="hidden" name="flagInfor" value="${IdforybUser }"/>
			<tr>
				<td height="30" align="left">&nbsp;</td>
				<td height="37" align="left">
				<input name="from" type="hidden" value="${existUser.yb_username}">[${existUser.yb_username} ]对 
			...
			<tr>
				...
				<td colspan="2" align="center" class="word_dark">&nbsp;All
					CopyRights reserved 2018    易班  工院易生活</td>
				<td align="center">&nbsp;</td>
			</tr>
		</form>
	</table>
