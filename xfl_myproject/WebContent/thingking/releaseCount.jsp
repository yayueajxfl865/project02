...
<div class="row"> 
	...
	<div class="col-md-8" style="background:#fff;padding:40px 80px;margin:30px;border:7px solid #ccc;">
		...
		<input type="hidden" value="y" name="kind">
			 <div class="form-group">
			   ...
			   <div class="form-group">
			    <label for="phoneNumber" class="col-sm-2 control-label">拾物地点</label>
			    <div class="col-sm-6">
			      <input type="text" class="form-control" id="phoneNumber" placeholder="请输入拾物地点" name="place">
			    </div>
			  </div>
			  
			   <div class="form-group">
			    <label for="userAddress" class="col-sm-2 control-label">拾物时间</label>
			    <div class="col-sm-6">
			      <input type="text" class="form-control" id="userAddress" placeholder="请输入拾物时间" name="gtime">
			    </div>
			  </div>
