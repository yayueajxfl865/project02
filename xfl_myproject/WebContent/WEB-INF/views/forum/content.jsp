...
<head>
    ...
    <title>论坛主页content</title>
    <link rel="icon" type="image/x-icon" href="${pageContext.request.contextPath }/views/forum/favicon.ico">
   
    <link rel="stylesheet" href="${pageContext.request.contextPath }/css/amazeui.min.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath }/css/wap.css@2">
</head>
<body>
<div data-am-widget="gotop" class="am-gotop am-gotop-fixed">
    <a href="#top" title="">
        <img class="am-gotop-icon-custom" src="${pageContext.request.contextPath }/img/goTop.png"/>
    </a>
</div>
            ...
            <div class="am-list-news-bd">
                <ul class="am-list">
                    ...
                    <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-right pet_list_one_block">
                        <div class="pet_list_one_info">
                            <div class="pet_list_one_info_l">
                                <div class="pet_list_one_info_ico">
                                    <img src="${pageContext.request.contextPath }/img/a6.png" alt="">
                                </div>
                        ...
                        <div class="am-u-sm-4 am-list-thumb pet_video_info">
                            <a href="###" class="">
                                <img src="${pageContext.request.contextPath }/img/q4.jpg" class="pet_list_one_img" alt="我很囧，你保重....晒晒旅行中的那些囧！"/>
                            </a>
                        </div>
				...
				<div style="width: 100%;height: 30px;margin-top: 0px;">
					...
					<div style="float: left;">
						<img src="${pageContext.request.contextPath }/img/ioc-zf.png" style="width: 20px; height: 20px;"/><font style="color: #757575;font-size: 15px;font-family:Simsun;">转发</font>
					</div>
					<div style="float: left;margin-left: 30px;">
						<img src="${pageContext.request.contextPath }/img/ioc-pl.png" style="width: 20px; height: 20px;"/><font style="color: #757575;font-size: 15px;font-family:Simsun;">评论</font>
					</div>
					<div style="float: left;margin-left: 30px;">
						<img src="${pageContext.request.contextPath }/img/ioc-z.png" style="width: 20px; height: 20px;"/><font style="color: #757575;font-size: 15px;font-family:Simsun;">点赞</font>
					</div>
...
<script src="${pageContext.request.contextPath }/views/forum/js/jquery.min.js"></script>
<script src="${pageContext.request.contextPath }/views/forum/js/amazeui.min.js"></script>
<script>
    $(function() {
