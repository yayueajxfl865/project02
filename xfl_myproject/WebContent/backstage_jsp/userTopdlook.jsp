...
<body>
	<div class="place">
		<span>位置：</span>
		<ul class="placeul">
			<li><a href="backstage_jsp/pdbyuser.jsp">首页</a></li>
			<li><a href="#">查看商品</a></li>
		</ul>
	</div>
	<form method="post">
...
<ul class="forminfo">
	...
	<li><label>所属分类</label><input name="price" type="text" disabled="disabled"
		value="${pd.getCategory() } " class="dfinput" /><i>多个关键字用,隔开</i></li>	
	...
	<li><a href="UserInpdServlet?method=getpdByid" target="rightFrame">返回首页</a></li>
	</div>
</ul>
		</div>
	</form>
